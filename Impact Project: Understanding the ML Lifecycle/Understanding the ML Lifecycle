...
| ------------------------- | ------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| KNN (K-Nearest Neighbors) | Classification, when similar examples likely share a label         | Makes predictions by looking at the K closest data points and going with the majority label. There is no real "training," just storing data and comparing at prediction time | ![[KNN image.png]]*Source: [ResearchGate](https://www.researchgate.net/figure/sualization-of-k-Nearest-Neighbors-with-two-classes-blue-circles-and-red-triangles-with_fig3_359786522)* |
| Decision Trees            | Classification or regression, when you want an interpretable model | Splits data into branches based on feature values, groups similar examples together at each split                                                                            | ![[DT image.png\|183]]*Source: [codementor](https://www.codementor.io/@mgalarny/visualizing-decision-trees-with-python-scikit-learn-graphviz-matplotlib-154mszcto7)*                   |
| Logistic Regression       | Binary classification                                              | Outputs a probability (0 to 1) that an example belongs to a class, based on a weighted combination of features                                                               | ![[LG image.png]] *Source: [Medium](https://medium.com/analytics-vidhya/logistic-regression-b30ca0bec653)*                                                                             |
| Linear Regression         | Predicting a continuous number                                     | Fits a straight line (or hyperplane) through the data to model the relationship between features and a numeric label                                                         | ![[LR image.png]]*Source: [python-graph-gallery](https://python-graph-gallery.com/556-visualize-linear-regression/)*                                                                   |
...
![[Pasted image 20260805013556.png|372]]
